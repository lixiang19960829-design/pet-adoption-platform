                    ...
                    <div className="flex items-center gap-2">
                        ...
                        {isLoading ? (
                            ...
                            <div className="hidden sm:flex items-center gap-2">
                                <Button variant="ghost" size="sm" onClick={() => handleLogin('github')}>
                                    GitHub 登录
                                </Button>
                                <Button size="sm" onClick={() => handleLogin('google')}>
                                    Google 登录
                                </Button>
                            </div>
                        )}
                ...
                >
                    <nav className="flex flex-col gap-1 pt-2">
                        ...
                        {!user && (
                            <>
                                <hr className="my-2 border-[hsl(var(--border))]" />
                                <Button variant="ghost" className="justify-start" onClick={() => handleLogin('github')}>
                                    GitHub 登录
                                </Button>
                                <Button className="justify-start" onClick={() => handleLogin('google')}>
                                    Google 登录
                                </Button>
                            </>
                        )}
